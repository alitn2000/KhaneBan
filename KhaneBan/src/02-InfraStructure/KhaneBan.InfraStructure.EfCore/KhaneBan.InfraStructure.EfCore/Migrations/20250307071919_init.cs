    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, "test1", 10000.0, 1, "1168BED7-A787-44E1-A869-7D150A038915", "Admin@gmail.com", false, "Admin", false, "Admin", false, null, "ADMIN@GMAIL.COM", "ADMIN", "AQAAAAIAAYagAAAAEOvg9YXtD3vUU1HJKeW0HtvT7mw4gxcEkV7WEeowmbaDuWYBe5QrqdVexXXaBhr4ag==", "09102123542", false, "desktop", new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "1168BED7-A787-44E1-A869-7D150A038916", false, "Admin" },
                    { 2, 0, "test2", 20000.0, 1, "5780E9A6-7966-48F0-AC09-20FA8EA4B212", "alitn2000@gmail.com", false, "Ali", false, "Tahmasebinia", false, null, "ALITN2000@GMAIL.COM", "ALITN2000", "AQAAAAIAAYagAAAAEH8AvcqgCMU+ZLyjOCvlGggjMG8L9Md3hOBE3HdZIUjilrfk06HD9xF+Lr2153Dkdw==", "09022004453", false, "desktop1", new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "5780E9A6-7966-48F0-AC09-20FA8EA4B213", false, "alitn2000" },
                    { 3, 0, "test3", 20000.0, 1, "3FEB408E-2E7D-4BB9-B80C-12A88348057D", "reza2000@gmail.com", false, "Reza", false, "Rezaei", false, null, "REZA2000@GMAIL.COM", "REZA2000", "AQAAAAIAAYagAAAAEGCUUoMZh1zNSXts5lajPw9SnzYBd4BdfHADQTl+30EJBqEJTwys7ohR0aCBRM72WQ==", "09102123543", false, "desktop2", new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "3FEB408E-2E7D-4BB9-B80C-12A88348057E", false, "reza2000" },
                    { 4, 0, "test4", 20000.0, 1, "1DBE15F3-BB61-4FC0-87EE-5383DC66CF51", "sara2000@gmail.com", false, "Sara", false, "Saraei", false, null, "SARA2000@GMAIL.COM", "SARA2000", "AQAAAAIAAYagAAAAEHxz3pCbfW82DQ2/d/B62KvLcRDS5PnptvLUcK00rW8V1d6Ukf6G+P1tKcg2uT+9Bg==", "09102123545", false, "desktop3", new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "1DBE15F3-BB61-4FC0-87EE-5383DC66CF52", false, "sara2000" },
                    { 5, 0, "test2", 20000.0, 1, "5780E9A6-7966-48F0-AC09-20FA8EA4B212", "expert12000@gmail.com", false, "expert1", false, "expertinia", false, null, " EXPERT12000@GMAIL.COM", "EXPERT12000", "AQAAAAIAAYagAAAAELjhbQXuTibfFmzqa8ILor4oKsK4YUM2c2Vg04sj1aos9+TmQNejI6ytPONQWUR5hw==", "09102123541", false, "desktop1", new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "5780E9A6-7966-48F0-AC09-20FA8EA4B213", false, "expert12000" },
                    { 6, 0, "test5", 20000.0, 1, "5780E9A6-7966-48F0-AC09-20FA8EA4B212", "expert22000@gmail.com", false, "expert2", false, "expertinia", false, null, " EXPERT22000@GMAIL.COM", "EXPERT22000", "AQAAAAIAAYagAAAAEH55lNy06IWgOzefvQp2OJjVAzy9NC8GLllEJfsRsLOKMswVu1n0e9NQ1D9/ZOfGLA==", "09102123542", false, "desktop1", new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "5780E9A6-7966-48F0-AC09-20FA8EA4B213", false, "expert22000" },
                    { 7, 0, "test7", 20000.0, 1, "5780E9A6-7966-48F0-AC09-20FA8EA4B212", "customer12000@gmail.com", false, "customer1", false, "customernia", false, null, "CUSTOMER12000@GMAIL.COM", "CUSTOMER12000", "AQAAAAIAAYagAAAAEIyCQ3mXZBjTpizYFtuPaU6OZbj3FN03ynZ64lXfCMHQD3V7sGlOmaFwATGKfnbuXw==", "09102123555", false, "desktop1", new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "5780E9A6-7966-48F0-AC09-20FA8EA4B213", false, "customer12000" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Ratings",
                columns: new[] { "Id", "Comment", "CustomerId", "ExpertId", "IsAccepted", "IsDeleted", "Rate", "RegisterDate", "Title" },
                values: new object[,]
                {
                    { 1, "اوکی", 1, 1, null, false, 5.0, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "تایتل" },
                    { 2, "اوکی", 2, 1, null, false, 5.0, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "تایتل" }
                });

            migrationBuilder.InsertData(
                table: "Requests",
                columns: new[] { "Id", "CityId", "CustomerId", "Description", "EndTime", "HomeServiceId", "IsDeleted", "RatingId", "RegisterDate", "RequestImages", "RequestStatus", "RequestedDate", "Title", "WinnerId" },
                values: new object[,]
                {
                    { 3, 1, 3, "نظافت راه پله ساختمان 4 طبقه", null, 2, false, null, new DateTime(2025, 3, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 2, new DateTime(2025, 3, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "نظافت راه پله", 0 },
                    { 1, 1, 1, "نقاشی 4 طبقه", null, 1, false, 1, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 5, new DateTime(2025, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "نقاشی", 0 },
                    { 2, 1, 2, "نقاشی 2 طبقه", null, 1, false, 2, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 5, new DateTime(2025, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "نقاشی", 0 }
                });
